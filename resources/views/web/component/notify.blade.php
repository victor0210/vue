@if(Auth::check()&&(Auth::user()->unreadNotifications->where('type','App\Notifications\Comments')->count()>0||Auth::user()->unreadNotifications->where('type','App\Notifications\Thumb')->count()>0)||Auth::user()->unreadNotifications->where('type','App\Notifications\Notify')->count()>0 )

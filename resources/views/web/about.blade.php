...
@section('content')
    <div class="row connection">
        <h1 class="text-center text-gray">About Us !</h1>
        <p class="text-center" style="color: #999">这里是一个看起来像博客的交流平台,大家可以在这里留下自己喜欢的文章,发表自己独到的见解。到了这里,可以瞬间拥有一个简易博客,尽情享受吧
            !</p>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <p id="reply-info" class="text-center"><img src="{{ elixir('images/qq.jpg') }}" style="max-width: 100%"></p>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->

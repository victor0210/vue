    ...
    <nav class="navbar navbar-fixed-top" role="navigation">
        <div id="navbar">
            <ul class="nav navbar-nav navbar-menu" data-tab="@yield('tab')">
                ...
                <li name="tab2"><a href="/music"><span class="glyphicon glyphicon-headphones"> 音乐广场</span></a></li>
                <li name="tab3"><a href="/about"><span class="glyphicon glyphicon-globe"> 关于我们</span></a></li>
                @if(!Auth::check())

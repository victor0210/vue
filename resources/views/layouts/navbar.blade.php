    ...
    <nav class="navbar navbar-fixed-top" role="navigation">
        <div id="navbar">
            <ul class="nav navbar-nav navbar-menu" data-tab="@yield('tab')">
                <li name="tab0"><a href="/collection"><span class="glyphicon glyphicon-home"> 推荐分类</span></a></li>
                <li name="tab1"><a href="/"><span class="glyphicon glyphicon-list-alt"> 博客公园</span></a></li>
                @if(!Auth::check())
